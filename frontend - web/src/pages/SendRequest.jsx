            ...
            <div class="bg-white -lime-700 pt-12 pr-0 pb-12 pl-0 mt-0 mr-auto mb-0 ml-auto sm:py-16 lg:py-20">
                <div class="pt-0 pr-4 pb-0 pl-4 mt-0 mr-auto mb-0 ml-auto max-w-7xl sm:px-6 lg:px-8">
                    <div class="pt-0 pr-4 pb-0 pl-4 mt-0 mr-auto mb-0 ml-auto max-w-4xl sm:px-6 lg:px-8">
                        <div class="pt-0 pr-4 pb-0 pl-4 mt-0 mr-auto mb-0 ml-auto  sm:items-center w-full">
                            <div>
              ...
              adipis</p> */}
                            ...
                            <div class="mt-4 mr-0 mb-0 ml-0 sm:mt-0">
                                <p class="sr-only">Search Patients to Send Request</p>
                                <div class="relative">
                    ...
                    21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                                    ...
                                    <input placeholder="Search Patients to Send Request " type="search" class="border block pt-2 pr-0 pb-2 pl-10 w-full py-2
                                ...
                                <div class="pt-5 pr-0 pb-0 pl-0 mt-5 mr-0 mb-0 ml-0">
                                    <div class="sm:flex sm:items-center sm:justify-between sm:space-x-5">
                                        <div class="flex items-center flex-1 min-w-0">
                                            ...
                                            <div class="mt-0 mr-0 mb-0 ml-4 flex-1 min-w-0">
                                                <p class="text-lg font-bold text-gray-800 truncate">Anil Bhai Tesla</p>
                                                {/* <p class="text-gray-600 text-md">Slack</p> */}
