      ...
      <div>
        <div className='flex justify-center items-center max-w-[1400px] mt-6 mx-auto h-[45vh]'>
          <div className='flex flex-col justify-center items-start p-4  h-[100%]'>
            ...
            <p className='text-primary text-xl w-[60%] my-4'>Opkit is a modern, developer-friendly health insurance verification platform used by leading organizations from across the healthcare ecosystem.</p>
